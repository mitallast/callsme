...
export interface WSResponseHandler<M = any> {
...
export class WSConnection {
    ...
    constructor(
        ...
        this.ws.onclose = () => {
            for (let response of this.waitingForResponse.values()) {
    ...
    public connectProducerTransport(dtlsParameters: DtlsParameters): Promise<ServerConnectedProducerTransport> {
        return this.call({
    ...
    public connectConsumerTransport(dtlsParameters: DtlsParameters): Promise<ServerConnectedConsumerTransport> {
        return this.call({
    ...
    public clientProduce(kind: MediaKind, rtpParameters: RtpParameters): Promise<ServerProduced> {
        return this.call({
            action: 'Produce',
            kind,
            rtpParameters
