...
pub enum ServerMessage {
    ...
    /// Notification that a new producer was added to the room
    #[serde(rename_all = "camelCase")]
    ProducerAdded {
    ...
    /// connection is just dropped, in a real-world application you probably want to handle it
    /// better)
...
pub enum InternalMessage {
    /// Save a producer in connection-specific hashmap to prevent it from being destroyed
    SaveProducer(Producer),
    /// Save a consumer in connection-specific hashmap to prevent it from being destroyed
